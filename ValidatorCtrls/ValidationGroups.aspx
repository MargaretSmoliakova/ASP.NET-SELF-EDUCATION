    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="83px" Width="296px">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ...
                ValidationGroup="FirstGroup" EnableClientScript="false"></asp:RequiredFieldValidator><br />
            <asp:Button ID="btnValidateRequired" runat="server" Text="Validate"
                OnClick="btnValidateRequired_Click" ValidationGroup="FirstGroup"/>
        </asp:Panel>
        ...
        <asp:Panel ID="Panel2" runat="server" Height="119px" Width="295px">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                ...
                ValidationExpression="\d{3}-\d{2}-\d{4}" ValidationGroup="SecondGroup"
                EnableClientScript="false"></asp:RegularExpressionValidator><br />
            <asp:Button ID="btnValidateSSN" runat="server" OnClick="btnValidateSSN_Click" 
                Text="Validate" ValidationGroup="SecondGroup"/>
        </asp:Panel>
    <div>
